  ...
  func setChartDescription(_ config: NSDictionary) {
    ...
    if json["positionX"].number != nil && json["positionY"].number != nil {
      chartDescription.position = CGPoint(
        x: CGFloat(json["positionX"].numberValue), y: CGFloat(json["positionY"].numberValue))
    }
      ...
      if let dict = object as? NSDictionary {
        ...
        if json["x"].double != nil {
          ...
          if json["stackIndex"].int != nil {
            highlight = Highlight(
              x: json["x"].doubleValue, dataSetIndex: dataSetIndex,
              stackIndex: json["stackIndex"].intValue)
          } else {
